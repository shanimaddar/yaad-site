...
const signals = [
  {
    icon: ShieldCheck,
    title: "מקצועיות",
    description: "אנחנו מגיעות עם ידע וניסיון של שנים בתחום הניקיון ומנהלות צוות של אלופים.",
  },
  {
    icon: Clock,
    title: "אמינות",
    description: "מגיעות בזמן, מסיימות בזמן. נקודה.",
  },
  {
    icon: UserCheck,
    title: "שירות אישי",
    description: "אנחנו מאמינות במענה אישי לפי צורכי הלקוח ותפירת חליפה מדוייקת על פי צרכיו.",
  },
]
